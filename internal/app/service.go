...
// AcknowledgeDashboardAction clears the exact plugin request the dashboard
// handled. Matching the id matters: an agent may ask again while the first
// request is still running, and that newer request must survive the older
// acknowledgement.
